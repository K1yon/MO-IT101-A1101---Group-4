...
public class PayslipGenerator {
    public static void generatePayslip(Employee employee, double hoursWorked, double grossSalary, 
        ...
        System.out.printf(" %-30s PHP %12.2f %n", "Total Allowances:", 
        ...
        System.out.printf(" %-30s PHP %12.2f %n", "Final Net Salary (With Allowances):", 
                          (netSalary + employee.getRiceSubsidy() + employee.getPhoneAllowance() + employee.getClothingAllowance()));
        System.out.println("===========================================");
    }
}
