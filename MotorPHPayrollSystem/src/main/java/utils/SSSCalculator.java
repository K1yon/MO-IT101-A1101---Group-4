...
public class SSSCalculator {
    public static double getSSSContribution(double salary) {
        double[][] sssBrackets = {
            ...
            {23250, 1035}, {23750, 1057.50}, {24250, 1080}, {24750, 1102.50}, {Double.MAX_VALUE, 1125}
        };

        for (double[] bracket : sssBrackets) {
            if (salary < bracket[0]) {
                return bracket[1]; // Employee share only (half of the total contribution)
            }
        }
        return 1125 / 2; // Max employee contribution
    }
}
