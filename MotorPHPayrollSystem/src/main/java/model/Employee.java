...
public class Employee {
    ...
    public Employee(String employeeNumber, String lastName, String firstName, String birthDate, String address,
                    String contactNumber, String tinNumber, String sssNumber, String philHealthNumber,
                    String pagIbigNumber, String employmentStatus, String position, String supervisor,
                    double basicSalary, double hourlyRate, double riceSubsidy, double phoneAllowance, double clothingAllowance) {
    ...
    // ✅ Getter methods to fix the compilation issue
    ...
    public String toString() {
        return String.format(
                ...
                pagIbigNumber, employmentStatus, position, supervisor, basicSalary, hourlyRate, riceSubsidy, phoneAllowance, clothingAllowance
        );
    }
}